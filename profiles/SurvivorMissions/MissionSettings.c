...
#include "$CurrentDir:\\mpmissions\\empty.deerisle\\SurvivorMissionModule\\EventsWorldData.c"
#include "$CurrentDir:\\mpmissions\\empty.deerisle\\SurvivorMissionModule\\Missions\\Missions.h"
