class eAI_Targetting_Follow_Reload_Transition extends eAITransition {
private eAI_Targetting_Follow_State src;
private eAI_Targetting_Reload_State dst;
void eAI_Targetting_Follow_Reload_Transition(eAIBase _unit, eAIHFSM _fsm) {
m_ClassName = "eAI_Targetting_Follow_Reload_Transition";
...
eAITransition Create_eAI_Targetting_Follow_Reload_Transition(eAIBase _unit, eAIHFSM _fsm) {
return new eAI_Targetting_Follow_Reload_Transition(_unit, _fsm);
}
